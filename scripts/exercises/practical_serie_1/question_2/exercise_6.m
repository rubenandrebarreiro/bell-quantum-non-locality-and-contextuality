...
% Create the trace of the multiplication
% between the density matrix rho = |psi><psi| for
% the two-dimensional quantum state psi vector
% and the Pauli X (sigma_x) Matrix,
% as an alternative form of {m}_{x}
m_x_alternative_form = simplify( trace( rho_density_matrix * ...
                                        pauli_sigma_x ) );

% Create the trace of the multiplication
% between the density matrix rho = |psi><psi| for
% the two-dimensional quantum state psi vector
% and the Pauli Y (sigma_y) Matrix,
% as an alternative form of {m}_{y}
m_y_alternative_form = simplify( trace( rho_density_matrix * ...
                                        pauli_sigma_y ) );

% Create the trace of the multiplication
% between the density matrix rho = |psi><psi| for
% the two-dimensional quantum state psi vector
% and the Pauli Z (sigma_z) Matrix,
% as an alternative form of {m}_{z}
m_z_alternative_form = trace( rho_density_matrix * ...
                              pauli_sigma_z );

% Create the vector with the multiple
% multiplication operations between the density
% matrix rho = |psi><psi| for the two-dimensional
% quantum state psi vector and the Pauli X, Y, and Z
% (sigma_x, sigma_y, and sigma_z) Matrices,
% as alternative forms of {m}_{x}, {m}_{y}, and {m}_{z}
m_vec = { m_x_alternative_form, ...
          m_y_alternative_form, ...
          m_z_alternative_form };
...
p_vec_m_plus = 1 / 2 * ( identity_matrix + ...
                         ( ( m_x_alternative_form * pauli_sigma_x ) + ...
                           ( m_y_alternative_form * pauli_sigma_y ) + ...
                           ( m_z_alternative_form * pauli_sigma_z ) ) ...
                        );
...
% and the Pauli X (sigma_x) Matrix,
% as an alternative form of {m}_{x}
fprintf('m_x = tr(rho * (sigma_x)) =\n');
disp(m_x_alternative_form);
...
% and the Pauli Y (sigma_y) Matrix,
% as an alternative form of {m}_{y}
fprintf('m_y = tr(rho * (sigma_y)) =\n');
disp(m_y_alternative_form);
...
% and the Pauli Z (sigma_z) Matrix,
% as an alternative form of {m}_{z}
fprintf('m_z = tr(rho * (sigma_z)) =\n');
disp(m_z_alternative_form);
