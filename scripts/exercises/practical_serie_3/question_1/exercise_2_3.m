...
% for the GHZ state, given a number n of parties
function ghz_state_rho_density_matrix = ...
         compute_ghz_state_rho_density_matrix(n)
...
function m_n_ghz_state_expectation_value = ...
    compute_m_n_ghz_state_expectation_value(n, a_operator_1, a_operator_2)
    
    % Compute the density matrix (rho)
    % for the GHZ state, given the number n of parties
    ghz_state_rho_density_matrix = ...
        compute_ghz_state_rho_density_matrix(n);
    ...
    % Conpute the expectation value <M_(n)> from the trace
    % for the multiplication of the density matrix (rho)
    % for the GHZ state for n parties and the  M_(n) Bell operator
    m_n_ghz_state_expectation_value = ...
        trace(ghz_state_rho_density_matrix * m_n_bell_operator);
